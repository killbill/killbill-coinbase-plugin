...
describe Killbill::Coinbase::CoinbasePaymentMethod do
  ...
  it 'should generate the right SQL query' do
    ...
    expected_query = "SELECT COUNT(DISTINCT \"coinbase_payment_methods\".\"id\") FROM \"coinbase_payment_methods\"  WHERE \"coinbase_payment_methods\".\"kb_payment_method_id\" = '1234' ORDER BY \"coinbase_payment_methods\".\"id\""
    ...
    expected_query = "SELECT  DISTINCT \"coinbase_payment_methods\".* FROM \"coinbase_payment_methods\"  WHERE \"coinbase_payment_methods\".\"kb_payment_method_id\" = '1234' ORDER BY \"coinbase_payment_methods\".\"id\" LIMIT 10 OFFSET 0"
    # Note that Kill Bill will pass a String, even for numeric types
    ...
    expected_query = "SELECT COUNT(DISTINCT \"coinbase_payment_methods\".\"id\") FROM \"coinbase_payment_methods\"  WHERE \"coinbase_payment_methods\".\"kb_payment_method_id\" = 'XXX' ORDER BY \"coinbase_payment_methods\".\"id\""
    ...
    expected_query = "SELECT  DISTINCT \"coinbase_payment_methods\".* FROM \"coinbase_payment_methods\"  WHERE \"coinbase_payment_methods\".\"kb_payment_method_id\" = 'XXX' ORDER BY \"coinbase_payment_methods\".\"id\" LIMIT 10 OFFSET 0"
  ...
  it 'should search all fields' do
    ...
    do_search('foo').size.should == 0
    do_search(pm.kb_payment_method_id).size.should == 1
    # Exact match only for api key
    do_search('3810234').size.should == 0
    do_search('38102343').size.should == 0
    ...
    do_search('foo').size.should == 0
    do_search(pm.kb_payment_method_id).size.should == 1
    do_search(pm2.kb_payment_method_id).size.should == 1
  end
